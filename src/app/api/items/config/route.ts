...
export async function POST(req: Request) {
  try {
    const body = (await req.json()) as { itemId?: string; hasRemainder?: boolean; gramsPerUOM?: number };
    ...
    const res = await db.setItemConfig(body.itemId, { hasRemainder, gramsPerUOM });
